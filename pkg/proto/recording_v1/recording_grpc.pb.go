...
const (
	RecordingService_SaveRecording_FullMethodName = "/recording.RecordingService/SaveRecording"
)
...
type RecordingServiceClient interface {
	...
	SaveRecording(ctx context.Context, in *SaveRecordingRequest, opts ...grpc.CallOption) (*SaveRecordingResponse, error)
}
...
func (c *recordingServiceClient) SaveRecording(ctx context.Context, in *SaveRecordingRequest, opts ...grpc.CallOption) (*SaveRecordingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SaveRecordingResponse)
	err := c.cc.Invoke(ctx, RecordingService_SaveRecording_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RecordingServiceServer interface {
	// Сохраняет запись конференции в Synxrondrive
	SaveRecording(context.Context, *SaveRecordingRequest) (*SaveRecordingResponse, error)
...
func (UnimplementedRecordingServiceServer) SaveRecording(context.Context, *SaveRecordingRequest) (*SaveRecordingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaveRecording not implemented")
}
...
func _RecordingService_SaveRecording_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SaveRecordingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecordingServiceServer).SaveRecording(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecordingService_SaveRecording_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecordingServiceServer).SaveRecording(ctx, req.(*SaveRecordingRequest))
	}
...
var RecordingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SaveRecording",
			Handler:    _RecordingService_SaveRecording_Handler,
		},
	},
